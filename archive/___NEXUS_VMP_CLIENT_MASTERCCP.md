...
### PHASE C9: Payment Approval Workflow ❌ TODO (2025-01-27)
| # | Task | Status | Notes |
|---|------|--------|-------|
| C9.1 | Payment state machine | ❌ | Not started |
| C9.2 | Approval threshold rules | ❌ | Not started |
| C9.3 | Dual control enforcement | ❌ | Not started |
| C9.4 | Payment run batching | ❌ | Not started |
| C9.5 | Release notification to vendor | ❌ | Not started |

**Blocked By:** Phase 13.3-13.4 (nexus routes must be mounted first)
...
### PHASE C10: Document Request Flow ❌ TODO (2025-01-27)
| # | Task | Status | Notes |
|---|------|--------|-------|
| C10.1 | Document requirement schema | ❌ | Not started (CCP typo: labeled C9.1-C9.5) |
| C10.2 | Request triggers vendor notification | ❌ | Not started |
| C10.3 | Vendor submits → appears in client view | ❌ | Not started |
| C10.4 | Client approves/rejects | ❌ | Not started |
| C10.5 | Expiry tracking | ❌ | Not started |

**Blocked By:** Phase 13.3-13.4 (nexus routes must be mounted first)

---

### PHASE C10: End-to-End Testing ❌ TODO (2025-01-27)
| # | Test Scenario | Status | Notes |
|---|---------------|--------|-------|
| C10.1 | Login as Alice (Alpha) → see Client dashboard | ❌ | Blocked: nexus routes not mounted |
| C10.2 | View vendor directory → see Beta, Gamma | ❌ | Blocked: nexus routes not mounted |
| C10.3 | View invoices → see invoices from Beta | ❌ | Blocked: nexus routes not mounted |
| C10.4 | Approve invoice → status changes | ❌ | Blocked: nexus routes not mounted |
| C10.5 | Create payment run → batch invoices | ❌ | Blocked: C9 not started |
| C10.6 | Approve payment → vendor sees notification | ❌ | Blocked: C9 not started |
| C10.7 | Request document → vendor sees request | ❌ | Blocked: C10 (doc request) not started |
| C10.8 | Vendor submits → client sees submission | ❌ | Blocked: C10 (doc request) not started |

**Blocked By:** 
- Phase 13.3-13.4 (nexus routes must be mounted for C10.1-C10.4)
- Phase C9 (payment workflow must exist for C10.5-C10.6)
- Phase C10 doc request (must exist for C10.7-C10.8)

**See:** `.dev/dev-note/CCP_VALIDATION_REPORT.md` for detailed validation
