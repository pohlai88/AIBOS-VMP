...
### PHASE 13: Legacy Removal ⚠️ PARTIAL (2025-01-27)
| # | Task | Status | Notes |
|---|------|--------|-------|
| 13.1 | Create migrations/099_remove_legacy_vmp.sql | ✅ Done | File exists |
| 13.2 | DROP all vmp_* tables | ❌ Not Executed | Migration ready but not run |
| 13.3 | Remove legacy route imports from server.js | ⚠️ BROKEN | Imports exist but files deleted |
| 13.4 | Mount nexus routes at / (root) | ❌ Not Done | Nexus routes not mounted |
| 13.5 | Delete legacy src files | ✅ Mostly Done | vendor.js, client.js, supabase.js deleted |
| 13.6 | Final cleanup commit | ❌ Not Done | Awaiting 13.2-13.4 completion |

**CCP-9: ⚠️ PARTIAL** - Migration file ready, but server.js has broken imports

**Critical Issues (2025-01-27):**
- 🔴 **BLOCKER:** `server.js` lines 18-19, 24 import deleted files (vendor.js, client.js, supabase.js)
- 🔴 **BLOCKER:** Nexus routes not mounted (all `/nexus/*` return 404)
- ⚠️ **WARNING:** Migration 099 not executed (vmp_* tables still exist)
