...
async function seed() {
    ...
    try {
        ...
        const users = [
            ...
            { email: 'vendor1@techsupply.com', display_name: 'TechSupply Admin', vendor_id: vendorIds[0] },
            { email: 'vendor2@globallog.com', display_name: 'Global Logistics User', vendor_id: vendorIds[1] }
        ];
        ...
        for (const user of users) {
            ...
            if (existing) {
                ...
                const passwordHash = user.email === 'admin@acme.com' 
        ...
        for (const caseId of caseIds.slice(0, 4)) { // Add steps to first 4 cases
        ...
        for (const caseId of caseIds.slice(0, 5)) { // Add messages to first 5 cases
