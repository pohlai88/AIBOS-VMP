...
describe('Button and Link Components: Unit Tests', () => {
  describe('Button Components', () => {
    it('should find all vmp-btn buttons in layout', () => {
      ...
      const buttonMatches =
        layoutContent.match(/<button[^>]*class="[^"]*vmp-btn[^"]*"[^>]*>/gi) || [];
    ...
    it('should find all vmp-action-button buttons', () => {
      ...
      const actionButtonMatches =
        layoutContent.match(/<button[^>]*class="[^"]*vmp-action-button[^"]*"[^>]*>/gi) || [];
  ...
  describe('Link Components', () => {
    it('should find all navigation links in layout', () => {
      ...
      const navLinks =
        layoutContent.match(/<a[^>]*class="[^"]*vmp-navigation-link[^"]*"[^>]*>/gi) || [];
    ...
    it('should verify HTMX attributes on navigation links', () => {
      ...
      const htmxLinks =
        layoutContent.match(/<a[^>]*hx-(get|post|put|delete|patch)=["'][^"']+["'][^>]*>/gi) || [];
    ...
    it('should verify form buttons submit correctly', () => {
      ...
      forms.forEach(form => {
        ...
        const hasSubmitButton =
          /<button[^>]*type=["']submit["']|type=["']button["'][^>]*>[\s\S]*?<\/button>/i.test(form);
